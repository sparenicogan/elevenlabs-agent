...
### 1.1 The model may recommend; only the backend may decide
...
### 1.3 Verification state lives in DynamoDB, not in the conversation
...
### 2.2 At least one factor must not be printed on an invoice
